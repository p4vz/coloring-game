...
The `src/art/princess/*.svg` kawaii princesses are **original art created for
this project** (generated by a small parametric script — no third-party or
branded characters), dedicated to the public domain under
...
| `src/art/princess/*`, `src/art/houses/*`, `src/art/stickers.js` | Original (this repo) | CC0 1.0 |
