...
- 📚 **4 categories**: Animals, Vehicles, Houses, Princess (~40 pictures)
...
derived from **Twemoji** (CC‑BY 4.0). Princesses, houses, and stickers are
original CC0 line art (the princesses are generated by a small parametric
script — no branded characters). See [`ATTRIBUTIONS.md`](./ATTRIBUTIONS.md) for credits, the
